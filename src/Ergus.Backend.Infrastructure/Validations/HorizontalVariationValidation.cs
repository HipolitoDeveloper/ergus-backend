...
{
    public class HorizontalVariationValidation : AbstractValidator<IHorizontalVariation>
    {
        public HorizontalVariationValidation()
        {
            RuleFor(x => x.Code)
            ...
            RuleFor(x => x.Color)
                ...
                .Length(1, 20).WithMessage("A Cor deve ter até 20 caracteres");
